...
- **Glassmorphism UI**: A premium "Apple-esque" Dark Mode design using blurs and translucent layers
...
3. **Important**: Ensure you have the correct NativeWind version (v2.0.11) and Tailwind (3.3.2) to avoid build errors:
...
Upon first launch, you will be asked for your Name, Income, and Recurring Bills.
...
To clear data, go to Profile → Settings → Reset All Data.
...
- **Daraja/PesaLink Integration**: Enable in-app payments
